...
* Для его работы необходимо в панели управления в разделе "__Маркетинг / Сервисы__" включить "__Яндекс Метрика__", в поле "__Идентификатор счетчика__" записать его ID из Яндекс Метрики.

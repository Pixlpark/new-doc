...
## Пример использования для КП
* В Pixlpark можно использовать Scriban для формирования HTML-шаблонов. Рассмотрим его использование на примере коммерческого предложения.

...
* Редактор встраивается в несколько шагов:
    ...
    2. [Реализация аутентификации](/dev/editor#реализация-аутентификации).
    ...
    5. [Упрощённый сценарий создания дизайна без регистрации](/dev/editor#создание-дизайна-без-регистрации).
...
## Создание дизайна без регистрации
* Ниже краткое описание сценария создания заказа без привязки дизайна к пользователю:
...
> Если пользователь отдельными запросами не регистрировался, то при каждом заказе в панели управления будет создаваться "пустой" пользователь.
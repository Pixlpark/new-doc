...
* Для вывода списка последних новостей на пользовательских страницах сайта существует специальная константа `[$lastNews$]` (`[$LastNews(tag:gifts)$]` - вывод списка новостей по тегу "__gifts__").
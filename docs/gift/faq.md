...
2. В разделе "__Сувениры / Настройка / Основное__" в блоке "__Настройка импорта__" переопределить стоимость продукции, которая по умолчанию совпадает с рекомендуемой розничной, получаемой от поставщиков через выгрузки. Например, нажать на "любой" вид нанесения, а затем в открывшемся модальном окне в поле "Множитель" задать 1,3, если стоимость продукции надо увеличить на 30%.

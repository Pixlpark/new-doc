...
```js
 ...
 Например, вместо "Ленина, 108" правильнее "Проспект Ленина, 108", т.к. в Томсе нет "улицы Ленина". Соответственно, подный адрес будет "Томск, Проспект Ленина, 108".
```
...
* В разделе "__Сувениры / Настройка / Основное__" в блоке "__Основная информация__" выключить настройку "Отображать информацию о поставщике", если требуется скрыть на сайте информацию о принадлежности продукта к каталогу. Либо же переименовать названия каталогов в разделе "__Сувениры / Настройка / Каталоги__".
* ![](../_media/gift/gift50.png)

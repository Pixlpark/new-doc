...
```js
 Сами подборки в PDF-формате подготавливаются через механизм презентаций (коммерческих предложений). 
 Для этого необходимо авторизоваться на сайте под учетной записью администратора, добавить в корзину продукты для 
 Например, вместо "Ленина, 108" правильнее "Проспект Ленина, 108", т.к. в Томсе нет "улицы Ленина".
```

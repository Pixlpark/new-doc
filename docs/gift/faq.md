...
* В разделе "__Сувениры / Настройка__" в блоке "__Основная информация__" выключить настройку "Отображать фильтр по каталогам на странице категории и в поиске", если требуется скрыть на сайте информацию о принадлежности продукта к каталогу. Либо же переименовать выводимые на сайте названия каталогов в разделе "__CMS / Локализация__" в папке `Enumeration.SupplierType`.

...
### Магазин
* `[$gifts$]` - список категорий и подкатегорий из раздела "__Магазин / Сувениры__" без функции поиска.
* `[$gifts(isSearchable:true)$]` - список категорий и подкатегорий из раздела с функцией поиска.

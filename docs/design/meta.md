...
* **`[meta:student]`** - группа, содержащая информация об ученике. В ней можно использовать слои со следующими ключами:
    ...
    + `[meta:cover without-bg bg-color:#FFFFFF]` - фотография на обложку с вырезанных фоном и залитым фоном (опционально);
    + `[meta:frame without-bg bg-color:#FFFFFF]` - фотография на виньетку с вырезанных фоном и залитым фоном (опционально);
    + `[meta:frame]` - фотография на виньетку;
    + `[meta:sign color:#FFFFFF]` - фотография подписи;

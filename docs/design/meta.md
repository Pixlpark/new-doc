...
## Подготовка шаблонов
* Шаблон альбома для старших классов должен сдержать следующие макеты:
    ...
    + **Виньетками с учениками**: фото классного руководителя, его пожелание и фото учеников;
    + **Виньетками с учителями**: большое фото классного руководителя, его пожелание и фото учителей (включая директора);
    + **Четыре разворота с учениками**: от 1 до 4 фото с пожеланиями на странице;
    + **Три разворота с друзьями**: от 4 до 7 рамок под фото;
    + **Разворот с общим фото**: большое фото всего класса;

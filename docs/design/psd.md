...
* Для упрощения этой работы мы разработали технологию выпускных альбомов, суть которой заключается в следующем:
    ...
    + Макет может содержать дизайн разворота с виньетками под различное количество учеников. Для этого все слои, относящиеся к определеному количеству учеников, размещаются в отдельных группах (например: "20 учеников").

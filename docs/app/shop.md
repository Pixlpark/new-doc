...
* В локализации текста подтверждения всех согласий можно использовать ссылки (при использовании языка разметки [Markdown](https://lifehacker.ru/chto-takoe-markdown/)):
    + Согласие на обработку персональных данных - `$personalDataFileUrl`,
    + Согласие на передачу данных третьим лицам - `$confidentialityPoliticFileUrl`,
    + Согласие с политикой конфиденциальности - `$thirdSidePersonalDataFileUrl`.
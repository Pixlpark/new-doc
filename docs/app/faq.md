...
+ __Список товаров__ - вывод калькулятора в виде списка товаров (не поддерживается для категорий имеющих опции).
+ __Онлайн-калькулятор__ - вывод калькулятора аналогично отображению на сайте (поддерживается для всех категорий).

...
* Для настройки интеграции необходимо выполнить следующие действия.
* Написать менеджеру Сбера.
* Зарегистрироваться в личном кабинете СберID.
* Подписать оферту в ЭДО.
* Вставить callback URL в личном кабинете СберID.
* Дождться активации личного кабинета Сбера.
* Скопировать ключи из личного кабинета СберID в административную панель Pixlpark.
![](../_media/integration/sber02.png ':size=70%')

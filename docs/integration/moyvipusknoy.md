...
description: Мой Выпускной, подключение к сервису, выпускные альбомы, фотоальбомы, школьные альбомы, выпускной
sidebar_position: 8
---
...
* Зарегистрироваться в сервисе фотограф может как [самостоятельно](https://admin.moyvipusknoy.ru/register), так и по реферальной ссылке типографии.
...
* Для подключения типографии к сервису необходимо выполнить несколько шагов:
    1. Оставить заявку в техподдержку Pixlpark на подключение к сервису.
...
* Для отображения в сервисе продукции типографии необходимо:
    ...
    2. В продуктах также указать наименование и при необходимости выставить настройку “Добавлять по умолчанию при регистрации в “Мой Выпускной” - в этом случае товар будет добавляться в коллекцию фотографа автоматически. Мы рекомендуем отмечать самые популярные товары, но чтобы суммарно их было не более 8 или 12 штук. Для визуализации товара в сервисе необходимо загрузить обложку или указать баннер с набором иллюстраций.

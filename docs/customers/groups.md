...
* __Cтратегии добавления в группу__ - правила, по которым можно либо вручную, либо автоматически добавлять клиентов в группу:
    ...
    + __Добавлять клиентов, зарегистрированных в период__ - добавлять клиентов, чье время с момента последнего посещения сайта входит в заданный период времени; пример: если задать период = "месяц", то в группе будут находиться пользователи, с момента последнего посещения сайта которых прошло не более 30 дней;
    + __Добавлять клиентов, оформивших заказы в период__ - добавлять клиентов, чей объем продаж за заданный период времени находится в установленном диапазоне; при этом объем можно считать как по всем, так и по определенным продуктам; пример: данная стратегия подходит для организации накопительных скидок;

...
* __Тип заказа__
    ...
    + __Быстрый заказ__ - заказ продукции через функционал быстрого заказа, который активируется в разделе "Заказы / Настройка / Оформление заказов → Быстрый заказ";
...
* __Разделить заказ__ - разделить заказ на несколько. При разделении в новый заказ будут перенесены выбранные продукеты из текущего.

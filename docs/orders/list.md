...
### Основная информация
* __Тип заказа__
    + __Обычный заказ__ - заказ материальной продукции с доставкой клиенту, прошедший все стандартные этапы оформления (редактор → корзина → доставка → оплата);
    + __Цифровой заказ__ - заказ цифровой продукции, прошедший все стандартные этапы оформления без выбора доставки. К данному виду относится продукты редактора сертификатов и редактора товаров с включенной настройкой "Пропускать страницу выбора доставки" (во вкадке "Редактор");
    + __Быстрый заказ__ - заказ продукции через функционал быстрого заказа (активируется в разделе "Заказы / Настройка / Оформление заказов → Быстрый заказ");
...
* __Детальная информация__ - подробная информация о выбранной доставке с возможностью ее изменения.
...
* __Отправить в Битрикс24__ - экспортировать данные по заказу в CRM-систему [Битрикс24](/integration/crm?id=Битрикс24).
* __Отправить в ASystem__ - экспортировать данные по заказу в ERP-систему [ASystem](/integration/crm?id=asystem).
* __Отправить в Axiom__ - экспортировать данные по заказу в ERP-систему [Axiom](/integration/crm?id=axiom).
* __Отправить в HelloPrint__ - экспортировать данные по заказу в ERP-систему [HelloPrint](/integration/crm?id=helloprint).
 ...
 * В свою очередь для каждой транзакции оплаты у заказа создается счет. 
 На каждую оплату с сайта или зачисление денег через панель управления в системе создается счет. При онлайн-оплате деньги автоматически зачисляются на баланс компании платежного сервиса, а соответствующий счет в системе помечается оплаченным (или частично оплаченным на фактическую сумму платежа).

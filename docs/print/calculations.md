...
* Более детально рассмотреть способы настройки расчета опций можно в разделе "[Калькуляторы](/category/калькуляторы)".
...
> Данный раздел отображается только при включенной функции расчета времени исполнения заказа, которая настраивается в разделе "[__Заказы / Настройка / Управление заказами / Время исполнения заказов__](/orders/settings#время-исполнения-заказов)".
...
> Данный раздел отображается только при заданный дополнительных полях в карточке опции в разделе "[__Дополнительные поля__](/print/calculations#карточка--поля-позиций)".
* В нем задаются значения определенных в опции полей.
* ![](../_media/print/position-fields.png)

### Позиция / Перегруженные артикулы
> Данный раздел отображается только при включенной настройке "[__Задавать значения артикула в товарах и опциях__](/print/settings#основная-информация)".
...
* В данном разделе представлен список опций, которые можно отфильтровать:
    ...
    + __По подрядчику__ (сотруднику с ролью "[подрядчик](/profile/staff#глобальные-роли)", привязанному к категориям).

...
* Отзывы, отмеченные сотрудниками компании как избранные, могут выводиться на любой странице сайта через константу `[$FavoriteFeedbacks$]` ( `[$FavoriteFeedbacks(tag:gifts,countSlides:2)$]` - вывод отзывов по тегу "__gifts__", с переопределенным количеством отзывов, по умолчанию количество выводимых отзывов задается в настройках раздела). 
